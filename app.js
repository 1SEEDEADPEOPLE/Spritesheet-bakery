...
function updateCamStepperDisplays(){
  document.getElementById('cam-x-val').textContent=cam.position.x.toFixed(2);
  document.getElementById('cam-y-val').textContent=cam.position.y.toFixed(2);
  document.getElementById('cam-z-val').textContent=cam.position.z.toFixed(2);
  document.getElementById('look-x-val').textContent=controls.target.x.toFixed(2);
  document.getElementById('look-y-val').textContent=controls.target.y.toFixed(2);
  document.getElementById('look-z-val').textContent=controls.target.z.toFixed(2);
...
function updateLightRotDisplays(){
  document.getElementById('sun-az-val').textContent=sunAzimuth+'°';
  document.getElementById('sun-el-val').textContent=sunElevation+'°';
  document.getElementById('fill-az-val').textContent=fillAzimuth+'°';
  document.getElementById('fill-el-val').textContent=fillElevation+'°';
}
