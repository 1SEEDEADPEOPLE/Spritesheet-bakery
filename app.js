  ...
  obj.root.traverse(n=>{
    ...
    mats.forEach(m=>{
      if(m.userData.shader){
        m.userData.shader.uniforms.uBrightness.value = obj.brightness;
        m.userData.shader.uniforms.uContrast.value = obj.contrast;
        m.userData.shader.uniforms.uSaturation.value = obj.saturation;
      }
    });
  });
}
